...
const meta = {
  ...
  argTypes: {
    ...
    offsetSeek: {
      defaultValue: 0,
      description: `영상 재생 시 해당 시간만큼 건너뛰어 재생합니다.`,
      type: 'number',
    },
    eventId: {
      defaultValue: '',
  ...
  args: {
    ...
    prerollAdType: 'IMA',
    prerollAdUrl: 'https://pubads.g.doubleclick.net/gampad/ads?iu=/21775744923/external/single_ad_samples&sz=640x480&cust_params=sample_ct%3Dlinear&ciu_szs=300x250%2C728x90&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&correlator=',
